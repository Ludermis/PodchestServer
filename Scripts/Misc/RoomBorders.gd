...
func init():
	...
	shape1.extents = Vector2(Vars.rooms[room].mapSizeX * Vars.rooms[room].gridSize / 2,2)
	shape2 = RectangleShape2D.new()
	shape2.extents = Vector2(2,Vars.rooms[room].mapSizeY * Vars.rooms[room].gridSize / 2)
	Physics2DServer.body_add_shape(body, shape1, Transform2D(0,Vector2(Vars.rooms[room].mapSizeX * Vars.rooms[room].gridSize / 2,2)))
	...
	Physics2DServer.body_add_shape(body, shape2, Transform2D(0,Vector2(-2,-Vars.rooms[room].mapSizeY * Vars.rooms[room].gridSize / 2)))
